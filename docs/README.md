...
- `reference/reference/` — frozen clean-room audit of the abandoned fork-based direction. These documents describe the reference codebase, not current Uncoil architecture.
